        ...
        <div style={s.center}>
          ...
          <form onSubmit={handleSubmit} style={s.form}>
            ...
            <button type="submit" style={s.btn}
              onMouseEnter={e => { e.target.style.background = "#e2ff00"; e.target.style.color = "#0a0a0a" }}
              onMouseLeave={e => { e.target.style.background = "transparent"; e.target.style.color = "#e2ff00" }}>
              RUN ANALYSIS →
            </button>
          </form>
...
const s = {
  root: { minHeight: "100vh", background: "#0a0a0a", color: "#f0f0f0", fontFamily: "'DM Mono','Courier New',monospace", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" },
  grid: { position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(255,255,255,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.03) 1px,transparent 1px)", backgroundSize: "60px 60px", pointerEvents: "none" },
  header: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "28px 48px", borderBottom: "1px solid rgba(255,255,255,0.06)", position: "relative", zIndex: 1 },
  ...
  eyebrow: { fontSize: "11px", letterSpacing: "0.25em", color: "rgba(255,255,255,0.35)", marginBottom: "24px" },
  ...
  accent: { color: "#e2ff00", fontStyle: "italic" },
  ...
  input: { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "4px", padding: "14px 16px", color: "#f0f0f0", fontSize: "14px", fontFamily: "inherit", outline: "none", transition: "border-color 0.2s", width: "100%", boxSizing: "border-box" },
  error: { color: "#ff6b6b", fontSize: "12px", letterSpacing: "0.05em" },
  btn: { background: "transparent", border: "1px solid #e2ff00", color: "#e2ff00", padding: "16px 48px", fontSize: "12px", fontFamily: "inherit", letterSpacing: "0.15em", fontWeight: "700", cursor: "pointer", borderRadius: "4px", transition: "all 0.2s", marginTop: "8px" },
  features: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginTop: "64px", width: "100%", textAlign: "left" },
  featureCard: { border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", padding: "20px", background: "rgba(255,255,255,0.02)" },
  featureNum: { fontSize: "10px", color: "rgba(226,255,0,0.5)", letterSpacing: "0.2em", marginBottom: "8px" },
  ...
  footer: { display: "flex", gap: "16px", padding: "24px 48px", fontSize: "11px", color: "rgba(255,255,255,0.2)", letterSpacing: "0.08em", borderTop: "1px solid rgba(255,255,255,0.06)", position: "relative", zIndex: 1, justifyContent: "center" },
  ...
  loadingBarFill: { position: "absolute", top: 0, left: 0, height: "100%", width: "40%", background: "#e2ff00", borderRadius: "2px", animation: "slide 1.8s ease-in-out infinite" },
