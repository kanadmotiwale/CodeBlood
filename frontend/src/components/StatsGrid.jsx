...
const s = {
  ...
  block: { border: "1px solid rgba(255,255,255,0.08)", borderRadius: "8px", padding: "28px", background: "rgba(255,255,255,0.02)" },
  ...
  item: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid rgba(255,255,255,0.05)" },
