...
const s = {
  ...
  block: { border: "1px solid rgba(191,90,242,0.15)", borderRadius: "8px", padding: "28px", background: "rgba(191,90,242,0.03)" },
  ...
  item: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid rgba(191,90,242,0.08)" },
