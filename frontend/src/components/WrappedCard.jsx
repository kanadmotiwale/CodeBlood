...
const s = {
  card: { border: "1px solid rgba(226,255,0,0.2)", borderRadius: "8px", padding: "32px", background: "rgba(226,255,0,0.03)" },
  ...
  index: { fontSize: "11px", color: "rgba(226,255,0,0.4)", letterSpacing: "0.1em" },
  archetypeName: { fontSize: "clamp(28px,3vw,40px)", fontFamily: "'DM Serif Display',Georgia,serif", fontWeight: "400", color: "#e2ff00", lineHeight: "1.1", marginBottom: "12px" },
  desc: { fontSize: "13px", color: "rgba(255,255,255,0.4)", lineHeight: "1.6", margin: "0 0 24px 0" },
  divider: { height: "1px", background: "rgba(255,255,255,0.07)", marginBottom: "24px" },
